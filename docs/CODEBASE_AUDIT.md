...
- 当前自动账户状态动作只有确保点赞与确保收藏。评论发送、关注、私信、分享、发布、删除和账号修改尚未进入已实现注册表。
...
Feed、Batch、搜索结果、有序直链、只读 Research、统一编译/审阅/批准/协调/账本以及选中设备范围检查均已通过无真机测试。任何真机执行仍要求对应能力档案的本地人工接受凭据。Mac/GPFS commit 对齐与 Hermes 02 号机真机验收在 Windows 清洁提交形成后执行。
