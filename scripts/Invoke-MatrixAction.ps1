param(
    ...
    [ValidateSet("Inventory", "DumpUi", "Screenshot", "OpenXhs", "OpenProfile", "Home", "Back", "ListApps", "StartApp", "StopApp", "OpenSettings", "TapText", "ScreenOff", "ScreenOn", "PushFile", "InstallApk", "SetResolution", "SetDensity", "ResetDisplay")]
    [string]$Action,
    [string]$ConfigPath,
    [string[]]$Serials,
