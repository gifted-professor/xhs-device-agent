...
const INTEGRATION_PATTERNS = Object.freeze([
  ...
  /^scripts\/(?:xhs-agent|repo-policy-scan|Run-Task|task-|legacy-task-converter|feed-device-runner|research-core|research-session|adb-research-provider|composite-)/u,
  /^config\/(?:composite-|task-spec)/u,
  /^tests\/(?:xhs-agent|xhs-entry|task-|legacy-task-converter|feed-device-runner|research-|composite-)/u,
