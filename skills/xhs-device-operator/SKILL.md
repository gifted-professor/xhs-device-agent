...
1. Read `docs/RESEARCH_AUTOMATION.md` and `docs/INPUT_METHOD_WORKFLOW.md` for task, result, and input contracts. Load `config/local.psd1` and the local per-device input policy without displaying or committing real identifiers.
